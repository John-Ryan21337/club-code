...
export const SETTINGS_PROFILE_FIELD_POLICY = {
  ...
  // Combining the separate atmosphere and media drafts does not widen profile
  // authority. Appearance/profile integration remains an explicit follow-up.
  fallingEffectsEnabled: "excluded",
  fallingEffectKind: "excluded",
  fallingEffectColor: "excluded",
  fallingEffectMatrixColorMode: "excluded",
  fallingEffectMatrixColorCycleSpeed: "excluded",
  fallingEffectMatrixBaseFontSize: "excluded",
  fallingEffectMatrixMotionMode: "excluded",
  fallingEffectMatrixWalkStartFontSize: "excluded",
  fallingEffectMatrixWalkEndFontSize: "excluded",
  fallingEffectMatrixWalkLifecyclePercent: "excluded",
  fallingEffectMatrixCenterWindIntensity: "excluded",
  fallingEffectOpacity: "excluded",
  fallingEffectSpeed: "excluded",
  fallingEffectDensity: "excluded",
  fallingEffectJapaneseRatio: "excluded",
