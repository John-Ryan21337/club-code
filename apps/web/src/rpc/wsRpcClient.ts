...
export interface WsRpcClient {
  ...
  readonly server: {
    ...
    readonly consumeResetCredit: RpcUnaryMethod<typeof WS_METHODS.serverConsumeResetCredit>;
  ...
  return {
    ...
    server: {
      ...
      consumeResetCredit: (input) =>
        transport.request((client) => client[WS_METHODS.serverConsumeResetCredit](input)),
