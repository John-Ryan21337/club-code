...
function DraftChatThreadRouteView() {
  ...
  // Same fail-closed rule as the server-thread route. A draft deep link must
  // not render before its project identity resolves.
  ...
  useEffect(() => {
    // Leave a pending draft on screen as a blank inset until bootstrap
    // finishes. Only redirect once the project list is authoritative, so a
    // slow environment does not bounce a visible draft away.
    if (
