    ...
    Effect.gen(function* () {
      ...
      yield* sql`
        ...
        VALUES (
          ...
          NULL,
          NULL,
          '{"authorityRevision":7,"mode":"steady-progress","prompt":"DO-NOT-FAN-OUT-SECRET-PROMPT","backgroundContinuation":true,"maxRounds":5,"armedAt":"2026-02-24T00:00:02.500Z","baselineSettledTurnId":null,"lastDispatchedSettledTurnId":null,"roundsDispatched":0,"lastDispatchedAt":null}',
          ${manualFollowUpsJson},
          'turn-1',
