 ...
 * incarnation prevents two Club Code runtimes from accidentally presenting the
...
export function hasLiveProviderRuntimeOwner(payload: unknown, observedAtMs: number): boolean {
  ...
  // A small skew allowance covers wall-clock adjustment across Club Code processes.
  if (
