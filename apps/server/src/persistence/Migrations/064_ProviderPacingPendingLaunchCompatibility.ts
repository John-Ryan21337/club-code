...
export default Effect.gen(function* () {
  ...
  if (existingColumns.length === 0) {
    ...
    /**
     * Legacy migration 62 created the six base columns, while legacy 63 added
     * these replay-safety fields. Check each column independently so this
     * reconciliation is safe for either completed migration and for a database
     * restored after a partially applied manual repair.
     */
