...
import Migration0034 from "./Migrations/034_ReconcileRunningActiveTurns.ts";
import Migration0035 from "./Migrations/035_ReconcileActiveTurnSessionStatus.ts";
...
import Migration0065 from "./Migrations/065_ProjectionThreadAutoNudge.ts";
...
export const migrationEntries = [
  ...
  [34, "ReconcileRunningActiveTurns", Migration0034],
  [35, "ReconcileActiveTurnSessionStatus", Migration0035],
  ...
  // IDs 63 and 64 are reserved by already-published pacing migrations on
  // active stack refs. The Effect migrator gates only by numeric id, so reuse
  // would make upgraded databases silently skip this exact-thread column.
  [65, "ProjectionThreadAutoNudge", Migration0065],
] as const;
