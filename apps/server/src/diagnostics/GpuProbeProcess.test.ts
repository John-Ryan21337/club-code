...
describe("buildGpuProbeEnvironment", () => {
  ...
  it("derives only canonical Windows loader variables from an accepted tuple", () => {
    expect(
      buildGpuProbeEnvironment(
        {
          SYSTEMROOT: "d:/WINDOWS/",
  ...
  it("does not forward inherited Windows program-directory overrides", () => {
    expect(
      buildGpuProbeEnvironment(
        {
          SystemRoot: "C:\\Windows",
          SystemDrive: "C:",
          ProgramFiles: "C:\\Users\\me\\planted",
          PROGRAMW6432: "D:\\Untrusted",
        },
        "win32",
      ),
    ).toEqual({
...
describe("GpuProbeProcess spawn contract", () => {
  it("launches the trusted executable with fixed argv, no shell, and no inherited stdin", async () => {
    ...
    expect(call.cwd).toBe("C:\\Windows\\System32");
