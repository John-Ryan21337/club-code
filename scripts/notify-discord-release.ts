  ...
  embeds: [
    {
      ...
      description:
        options.target === "prerelease"
          ? "A new Club Code prerelease is available for nightly testers."
          : "A new Club Code latest release is available.",
...
).pipe(Command.withDescription("Post a Club Code release announcement to Discord."));
