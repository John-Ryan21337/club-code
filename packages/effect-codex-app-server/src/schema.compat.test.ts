...
it("encodes the Codex 0.147 section filter and provider-private thread move", () => {
  ...
  assert.deepEqual(
    Schema.decodeUnknownSync(CodexSchema.V2ThreadSectionListResponse)({
      data: [
        {
          id: "0199f60f-45af-7000-8000-000000000001",
...
it("decodes the Codex 0.147 non-blocking user-input request metadata", () => {
