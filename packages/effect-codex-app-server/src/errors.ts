 ...
 * raised as soon as a single line passes the configured byte ceiling, before
 * the retained parts are joined or decoded, and deliberately carries only the
 * configured public limit - not provider response content, filesystem paths, or
 * a nested cause that could escape into Club Code diagnostics.
 */
