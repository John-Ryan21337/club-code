  ...
  it("bounds ambient colors, Matrix color modes and cycle speed, opacity, motion, density, Japanese ratio, and layout enums", () => {
    expect(
      decodeClientSettingsPatch({
        ...
        fallingEffectMatrixWalkLifecyclePercent: MIN_FALLING_EFFECT_MATRIX_WALK_LIFECYCLE_PERCENT,
        fallingEffectMatrixCenterWindIntensity: MAX_FALLING_EFFECT_MATRIX_CENTER_WIND_INTENSITY,
    ...
    for (const invalidPatch of [
      ...
      { fallingEffectMatrixWalkEndFontSize: Number.NaN },
      {
        fallingEffectMatrixWalkLifecyclePercent:
          MIN_FALLING_EFFECT_MATRIX_WALK_LIFECYCLE_PERCENT - 1,
      },
      {
        fallingEffectMatrixWalkLifecyclePercent:
          MAX_FALLING_EFFECT_MATRIX_WALK_LIFECYCLE_PERCENT + 1,
      },
      { fallingEffectMatrixWalkLifecyclePercent: 30.5 },
      {
        fallingEffectMatrixCenterWindIntensity: MIN_FALLING_EFFECT_MATRIX_CENTER_WIND_INTENSITY - 1,
      },
      {
        fallingEffectMatrixCenterWindIntensity: MAX_FALLING_EFFECT_MATRIX_CENTER_WIND_INTENSITY + 1,
      },
      { fallingEffectMatrixCenterWindIntensity: 4.5 },
