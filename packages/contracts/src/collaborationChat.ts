...
export const COLLABORATION_CONTEXT_EXCLUDED_SOURCE_MAX_COUNT =
  COLLABORATION_CONTEXT_SOURCE_MAX_COUNT * 2;
...
export const CollaborationContextPacket = Schema.Struct({
  ...
  excludedSources: Schema.Array(CollaborationContextExcludedSource).check(
    Schema.isMaxLength(COLLABORATION_CONTEXT_EXCLUDED_SOURCE_MAX_COUNT),
  ),
