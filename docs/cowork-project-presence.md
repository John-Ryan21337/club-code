...
opening with the same request ID is idempotent, as are heartbeat receipts and
accepted close receipts.
...
gets pseudonymous project/actor references and operation outcome only.
