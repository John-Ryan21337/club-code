...
| 1D   | Truthful resources            | #7 -> #23 -> #33                                                                                                                                                                                                  | CPU and effective RAM measurements distinguish warming/unavailable from zero, graph unavailable values as gaps, and actually hide unavailable cards. Do not combine this with the overlapping #8/#15 route.                                                 |
